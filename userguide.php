                            ...
                            <div id="right">
                                <div class="tit_bot">
                                    ...
                                    <div style="text-align: justify;">
                                        <p>PIBAS FedSPARQL allows users to easily run predefined Federated SPARQL queries across multiple data sources (Bio2RDF, Chem2Bio2RDF, EMBL-EBI and CPCTAS). As an advanced feature, system can detect similar data items (instance matching). </p>
                                        <br/>
                                        ...
                                        <p><b>Basic steps:</b><br/> 
                                            ...
                                            <p><b>Additional features</b><br/><br/>
                                                ...
                                                <br/><br/>
                                                <p style="text-align: justify;"><b>3. Detection of similar data items</b>: This option can be applied on the results of predefined queries as well as on the results retrieved after adding a new dataset. This feature could be disabled for some templates in DataSources ontology. It is important for some Biology and Chemogenomic topics. Researchers can find the most similar targets by click on button "Detect similar data items".</p><br/>
                                                <div class="pic">
                                                    <table style="border-style: double;" cellspacing="10px;">
